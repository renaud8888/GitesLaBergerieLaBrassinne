...
export const aroundRecommendations: AroundRecommendation[] = [
  {
    ...
    cuisineType: 'Brasserie, grillades, produits locaux',
    priceRange: '€€',
    ...
    notesForAdmin: 'Le site officiel indique Rue du Commerce 39, Libin, téléphone +32 460 96 54 61.',
  },
  {
    id: 'restaurant-le-moulin-de-la-dime',
    aliases: ['Le Moulin de la Dîme'],
    category: 'restaurant',
    section: 'restaurants',
    locationLabel: 'Redu',
    distanceFromGite: 'Environ 10 min',
    cuisineType: 'Restaurant cosy, produits du terroir, cuisine belge/européenne',
    priceRange: '€€',
    tags: ['terroir', 'moulin', 'redu'],
    websiteUrl: 'https://www.lemoulindeladime.com/',
    mapsUrl: 'https://www.google.com/maps/search/?api=1&query=Le%20Moulin%20de%20la%20D%C3%AEme%2064%20place%20de%20l%27ESRO%206890%20Redu',
    phone: 'tel:+32498367999',
    notesForAdmin: 'Adresse indiquée : 64 place de l’ESRO, 6890 Redu. Vérifier les horaires avant tout affichage public détaillé.',
  },
  {
  ...
  {
    id: 'walk-promenade-de-la-lesse',
    aliases: ['Promenade de la Lesse', 'Lesse walk', 'Wandeling langs de Lesse'],
    category: 'walk',
    section: 'promenades',
    locationLabel: 'Lesse / Redu',
    distanceFromGite: 'Environ 10 à 15 min',
    walkDistance: '8,6 km',
    difficulty: 'moyen',
    tags: ['lesse', 'rivière', 'nature'],
    websiteUrl: 'https://www.ardennebelge.be/diffusio/fr/p/itineraire/promenade-de-la-lesse-libin_TFOLOD-A0-0029-26X7/',
    mapsUrl: 'https://www.google.com/maps/search/?api=1&query=Lesse%206890%20Libin%20Belgique',
    notesForAdmin: 'Promenade de la Lesse : vérifier le point de départ exact avant d’ajouter des consignes plus détaillées.',
  },
  {
  ...
  },
  {
    ...
    category: 'village',
    section: 'villages-patrimoine',
    locationLabel: 'Lesse / commune de Libin',
    distanceFromGite: 'Environ 10 à 15 min',
    tags: ['lesse', 'nature', 'hameau'],
    websiteUrl: 'https://beauxvillages.be/villages/redu-lesse-sechery/',
    mapsUrl: 'https://www.google.com/maps/search/?api=1&query=Lesse%206890%20Libin%20Belgique',
    notesForAdmin: 'Entrée liée à Redu, Lesse & Séchery. Distance à vérifier selon le point de départ conseillé.',
  },
  {
