...
export const reviewLabels = {
  fr: {
    ...
    airbnbBrassineCta: 'Voir les avis Airbnb La Brassine',
  ...
  nl: {
    ...
    airbnbBrassineRating: '5/5 op Airbnb · La Brassine',
